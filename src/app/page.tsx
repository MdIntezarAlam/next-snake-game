...
const SnakeGame = () => {
  ...
  return (
    <div className="w-full sm:w-1/2 flex flex-col gap-2 lg:py-4 items-center justify-center mx-auto bg-[#333232] rounded-md">
      ...
      <div className="w-full h-[40px] lg:h-[50px] flex items-center justify-between  bg-orange-300 px-4">
        <button
      ...
      <div className="w-full h-[40px] lg:h-[50px] flex items-center justify-center gap-5 bg-purple-300 px-4">
        <button
          className="h-[70%] w-full text-sm rounded-full bg-purple-500 text-white"
          type="button"
          onClick={togglePause}
        >
      ...
      <div className="flex flex-col gap-2 sm:hidden w-[70%] rounded-md">
        <button
